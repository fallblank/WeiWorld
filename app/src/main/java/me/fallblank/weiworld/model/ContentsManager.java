...
public class ContentsManager extends BaseModel {
    ...
    public ContentsManager(Context context, List<Weibo> dataList, ILoader loadListner) {
    ...
    public void initQueryMap(Context context) {
        ...
        mQueryMap.put(ContentsManager.kEY_ACCESS_TOKEN, token);
    }

    public void loadMore() {
        mQueryMap.put(ContentsManager.kEY_COUNT, mLoadPageSize);
        mQueryMap.put(ContentsManager.kEY_PAGE, mPageIndex);
        mQueryMap.put(ContentsManager.KEY_MAX_ID, mMaxID);
     ...
     */
    public void refresh() {
        mQueryMap.put(ContentsManager.kEY_COUNT, mRefreshPageSize);
        mQueryMap.put(ContentsManager.kEY_PAGE, mPageIndex);
        mQueryMap.put(ContentsManager.KEY_SINCE_ID, mSinceID);
        mServer.listLastWeibo(mQueryMap)
                .subscribeOn(Schedulers.io())
                .map(new Function<ContentsResponse, ContentsResponse>() {
                    @Override
