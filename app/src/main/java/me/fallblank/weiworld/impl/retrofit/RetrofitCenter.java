...
public class RetrofitCenter {
    ...
    public IPublicTimeline getPublicTimeline() {
        return mRetrofit.create(IPublicTimeline.class);
    }
    
    public IComment getComment() {
        return mRetrofit.create(IComment.class);
    }
    
    public IMention getMention() {
        return mRetrofit.create(IMention.class);
    }
    
    public IBilateral getBilateral() {
        return mRetrofit.create(IBilateral.class);
    }
}
