...
import me.fallblank.weiworld.model.MentionManager;
...
public class MentionFragment extends BaseFragment {
    ...
    private MentionManager mMentionManager;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mMentionManager = new MentionManager(mContext, mWeiboList);
        ...
        mWrapperAdapter.setBottomListener(new LoadMoreWrapperAdapter.OnBottomListener() {
            ...
            public void onBottom() {
                mMentionManager.loadMore();
            }
        });
        mMentionManager.setRefreshListener(new ILoader() {
            @Override
            public void start() {
        ...
        mMentionManager.setLoadMoreListener(new ILoader() {
            @Override
            public void start() {
        ...
        mMentionManager.setNoMoreDataListener(new OnNoMoreDataListener() {
            @Override
